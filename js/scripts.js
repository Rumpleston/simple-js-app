// Create an array of Pokemon objects, each object containing the name, height, and type(s) of a Pokemon
let pokemonList = [{name:'Jigglypuff', height:'0.5', type:['Fairy, Normal'] },
...
// Check if the Pokemon's height is less than 0.6, and if so, add a comment about its size
    if (pokemonList[i].height < 0.6) {
         pokemonText += ' - that is a small Pokemon';
    }
// Close the paragraph HTML tag
    pokemonText += '</p>';
